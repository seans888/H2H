...
<div class="container push-md">
    ...
    <div class="col-lg-8">
        <form action="../functions/edit_admin_info.php" method="POST" id="adminAccounts">
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-sm-6">
                    <a href="index.php" role="button" class="btn btn-blue btn-block"><i class="fa fa-minus mr-2" aria-hidden="true"></i> Cancel</a>
                </div>
            </div>
        </form>
    </div>
