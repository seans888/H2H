...
<div class="container push-md">
    ...
    <div class="col-lg-6">
        <form action="../functions/add_admin.php" method="POST" id="userAccounts">
            ...
            <div class="col-sm-6">
                <button type="submit" name="submit" class="btn btn-blue btn-block"><i class="fa fa-plus mr-2" aria-hidden="true"></i> Create account</button>
            </div>
        </form>
            <div class="col-sm-6">
                <a href="admin_accounts.php" role="button" class="btn btn-danger btn-block"><i class="fa fa-times mr-2" aria-hidden="true"></i> Cancel</a>
            </div>
            </div>
