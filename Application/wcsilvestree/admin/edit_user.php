...
<?php
    if(isset($_GET["id"])) {
        $current_id = $_GET["id"];
        $query  = "SELECT * FROM ";
        $query .= "user_accounts WHERE id = {$current_id}";
        ...
        if($status == 0) {
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-sm-3">
                <a href="../functions/delete_user_admin.php?id=' . $current_id . '" id="delete" role="button" class="btn btn-danger btn-block"><i class="fa fa-times mr-2" aria-hidden="true"></i> Delete</a>
                </div>
                <div class="col-sm-3">
                    <a href="user_accounts.php" role="button" class="btn btn-primary btn-block"><i class="fa fa-minus mr-2" aria-hidden="true"></i> Cancel</a>
                </div>
            </div>
            ';
        } else {
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-sm-4">
                    <a href="user_accounts.php" role="button" class="btn btn-blue btn-block"><i class="fa fa-minus mr-2" aria-hidden="true"></i> Cancel</a>
                </div>
            </div>
            ';
        }
...
<div class="container push-md">
    <div class="row no-gutters">
        <?php echo message(); ?>
        <div class="col-lg-12">
            <h1><?php echo $action; ?> User Account</h1>
        </div>
    </div>
    <hr />
    ...
    <div class="col-lg-8">
        <form action="../functions/edit_user_admin.php" method="POST" id="userAccounts">
