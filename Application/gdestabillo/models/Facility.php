...
class Facility extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Employee::className(), ['id' => 'employee_id'])->viaTable('employee_has_facility', ['facility_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Schedule::className(), ['id' => 'schedule_id'])->viaTable('schedule_has_facility', ['facility_id' => 'id', 'facility_checklist_id' => 'checklist_id']);
    }
}
